...
return [
    ...
    'products-table' => [
        ...
        'awsDate' => 'Date',
        'awsCategory' => 'Category',
        'awsSource' => 'Source',
        'awsTerm' => 'Term',
        'awsItemId' => 'Item ID',
        'awsPrice' => 'Price',
        'awsPriceStockx' => 'Stockx Price',
        'awsPriceFlightClub' => 'Flight Club Price',
        'awsPriceGoat' => 'Goat Price'
    ],

    'buttons' => [
        'create-new'    => 'Add New Product',
