...
@section('content')
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-10 offset-lg-1 createData ">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="row">
              <div class="offset-md-1 col-sm-4 col-md-2">
                {{-- <div class="border-1 col-sm-4 offset-sm-2 col-md-2 offset-md-3"> --}}
                <img src="@if ($user->profile && $user->profile->avatar_status == 1) {{ $user->profile->avatar }} @else {{ Gravatar::get($user->email) }} @endif" alt="{{ $user->name }}" style="max-width:100%;max-height:100%" class="rounded-circle center-block mb-3 mt-4 user-image">
              </div>
              <div class="offset-md-1 col-sm-4 col-md-8">
                ...
                @if ($user->profile)
                  <div class="text-center text-left-tablet mb-4">
                    ...
                    {{-- {!! Form::open(array('url' => 'users/' . $user->id, 'class' => 'form-inline d-inline-block', 'data-toggle' => 'tooltip', 'data-placement' => 'right', 'title' => trans('usersmanagement.deleteUser'))) !!}
            ...
            @if ($user->job_title)
                ...
                <div class="col-sm-5 col-6 text-larger">
                    <strong>
                    {{ trans('usersmanagement.labelJobTitle') }}
                    </strong>
                </div>
            ...
            @if ($user->address)
                ...
                <div class="col-sm-5 col-6 text-larger">
                    <strong>
                    {{ trans('usersmanagement.labelAddress') }}
                    </strong>
                </div>
