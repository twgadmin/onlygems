        ...
        <div class="row">
            <div class="col-12 col-md-10 offset-md-1 col-lg-8 offset-lg-2">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="col">
                        <img style="max-width: 100%; max-height:100%; width:25%" src="@if ($user->profile->avatar != "") {{ $user->profile->avatar }} @else <?php echo asset('storage/avatar.png'); ?> @endif" alt="{{ $user->name }}" class="user-avatar img-circle">
                    </div>
