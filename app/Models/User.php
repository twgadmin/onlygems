...
class User extends Authenticatable
{
    ...
    {
        $userslist = array();
        $userslist['users'] = $this->whereHas('roles', function($q){ $q->where('slug', 'user'); })->get('users.*');

        $userslist['users_count'] = $this->whereHas('roles', function($q){ $q->where('slug', 'user'); })->count();
